...
//This was created according to the instructions at: http://answers.unity3d.com/questions/1012705/unity-ui-mouse-clicks-clearing-selected-object-in.html
namespace UnityEngine.EventSystems
{
    ...
    public class MyInputModule : PointerInputModule
    {
        ...
        protected bool SendUpdateEventToSelectedObject()
        {
            ...
            ExecuteEvents.ExecuteHierarchy(eventSystem.currentSelectedGameObject, data, ExecuteEvents.updateSelectedHandler);
            return data.used;
        }
        ...
        protected void ProcessMousePress(MouseButtonEventData data)
        {
            ...
            if (data.PressedThisFrame())
            {
                ...
                //**~~!!Commenting this line out according to instructions on top linked site
